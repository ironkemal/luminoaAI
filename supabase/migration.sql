-- ============================================================
-- Lumino AI — Supabase Migration
-- Supabase Dashboard > SQL Editor'a kopyalayıp çalıştır
-- ============================================================
...
CREATE POLICY "Users can manage own CV data"
  ON public.cv_data FOR ALL
...
-- 4. MESSAGES (chat messages within a session)
...
CREATE POLICY "Users can view own session analysis"
  ON public.session_analysis FOR ALL
  USING (
    auth.uid() = (
      SELECT user_id FROM public.sessions WHERE id = session_id
    )
...
-- ============================================================
-- DONE!
-- Tablolar: profiles, cv_data, sessions, messages, session_analysis, todos
-- ============================================================
