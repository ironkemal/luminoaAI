...
export const translations = {
  tr: {
    ...
    // AI Coach
    coachTitle: "Yapay Zeka PT & Akıllı Antrenör",
    coachSubtitle: "Gemini Flash motoru, hafıza matrisi ve tam program oluşturucu",
    tabAnalysis: "Analiz & Durum",
    tabMemory: "Karar Hafızası",
    tabChat: "Yapay Zekayla Konuş",
    tabVoice: "Sesli PT Koç",
  ...
  en: {
    ...
    // AI Coach
    coachTitle: "AI Personal Trainer & Smart Coach",
    coachSubtitle: "Powered by Gemini Flash, decision matrix & full program generator",
    tabAnalysis: "Analysis & Status",
    tabMemory: "Decision Memory",
    tabChat: "Chat with AI",
  ...
  de: {
    ...
    // AI Coach
    coachTitle: "KI-Personal Trainer & Smarter Coach",
    coachSubtitle: "Gemini Flash-Engine, Entscheidungsmatrix & Programmgenerator",
    tabAnalysis: "Analyse & Status",
    tabMemory: "Entscheidungsspeicher",
    tabChat: "Mit KI chatten",
